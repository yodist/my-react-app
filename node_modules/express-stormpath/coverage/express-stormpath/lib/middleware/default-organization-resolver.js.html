...
<html lang="en">
<head>
    <title>Code coverage report for express-stormpath/lib/middleware/default-organization-resolver.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">express-stormpath/lib/middleware/</a> default-organization-resolver.js
    </h1>
    <div class='clearfix'>
...
function defaultOrganizationResolver(req, res, next) {
  ...
  var cacheTtl = config.cacheOptions &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >config.cacheOptions.ttl !== undefined</span>
    ? <span class="branch-0 cbranch-no" title="branch not covered" >config.cacheOptions.ttl</span>
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (web.multiTenancy.strategy === 'subdomain') {
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Wed Dec 14 2016 15:07:16 GMT-0800 (PST)
</div>
</div>
